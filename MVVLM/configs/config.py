...
parser = argparse.ArgumentParser(description="hyper-parameter for MVVLM")
# ========================= Dataset Configs ==========================
...
parser.add_argument('--dataset', type=str, default='screen_proj', help="screen_proj")
parser.add_argument('--annotation', type=str, default=r'./annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'.images', help="base dir to help find images")
...
parser.add_argument('--base_dir_text', type=str, default = None)
parser.add_argument('--base_dir_text2', type=str, default = None)
# ========================= Model Settings ============================
...
parser.add_argument('--num_classes', default=14, type=int, help='Number of the classes for the classification loss.')
...
parser.add_argument('--TRAINMODE', default='len4', type=str)
